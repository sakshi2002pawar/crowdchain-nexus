...
const mockCampaigns: Campaign[] = [
  {
    ...
    goal: ethers.utils.parseEther("10").toNumber(),
    raised: ethers.utils.parseEther("4").toNumber(),
  ...
  },
  {
    ...
    goal: ethers.utils.parseEther("15").toNumber(),
    raised: ethers.utils.parseEther("7.5").toNumber(),
